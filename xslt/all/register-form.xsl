...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template name="register-form">
        ...
        <div class="container">
            <input type="password" name="password1" placeholder="{$locale/auth/placeholders/password}"/>
            <span class="status">
                <xsl:value-of select="$locale/auth/fieldDescs/password"/>
            </span>
        </div>
        <div class="container">
            <input type="password" name="password2" placeholder="{$locale/auth/placeholders/password}"/>
            <span class="status">
                <xsl:value-of select="$locale/auth/fieldDescs/password2"/>
            </span>
        </div>
        <div class="container">
            <input type="text" name="nickname" placeholder="{$locale/auth/placeholders/nickname}"/>
            <span class="status">
        ...
        <div class="container">
            ...
            <input type="text" name="capcha" style="width: 170px;" placeholder="{$locale/auth/placeholders/captcha}"/>
            <span class="status">
